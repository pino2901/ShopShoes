...
public class OrderServiceImpl implements OrderService {
	...
	public synchronized Order createOrder(ShoppingCart shoppingCart, Shipping shipping, Payment payment, User user) {
		...
		order.setOrderDate(Date.from(today.atStartOfDay(ZoneId.of("Asia/Ho_Chi_Minh")).toInstant()));
		order.setShippingDate(Date.from(estimatedDeliveryDate.atStartOfDay(ZoneId.of("Asia/Ho_Chi_Minh")).toInstant()));
