...
import com.nico.store.store.config.EmailConfig;
import com.nico.store.store.domain.*;
import com.nico.store.store.repository.ConfirmationTokenRepository;
...
//		helper.setFrom(from);
		...
		boolean html = true;
		helper.setText("<b>Hey guys</b>,<br><i>Welcome to shop Shoepp</i><br>" +
				"<i>UserName: </i>"+user.getUsername()+"<br><i>Password: </i>"+password, html);
